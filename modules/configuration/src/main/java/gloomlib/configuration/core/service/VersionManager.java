...
public final class VersionManager {
     ...
     */
    VersionCheckResult checkVersion(Class<? extends ConfigurationFile> clazz, File file) throws Exception {
        // Find @Version field
        ...
        for (Field field : clazz.getFields()) {
            if (field.isAnnotationPresent(gloomlib.configuration.api.annotation.Version.class)) {
                versionField = field;
                var annotation = field.getAnnotation(gloomlib.configuration.api.annotation.Version.class);
     ...
     */
    <T extends ConfigurationFile> T handleVersionUpgrade(Class<T> clazz, File file, VersionCheckResult versionCheck) throws Exception {
    ...
    private void migrateConfigData(YamlConfiguration oldYaml, ConfigurationFile newInstance) throws Exception {
        for (FieldMeta meta : ConfigurationCache.getCachedMeta(newInstance.getClass())) {
            ...
            if (meta.isAnnotationPresent(gloomlib.configuration.api.annotation.Version.class)) {
                continue;
            }
